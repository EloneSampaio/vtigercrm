...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'portal.url' => 'http://localhost/vtigercrm/portal',

		'crm.version' => '7.1.0', // Framework version for API
		'language' => 'pt_br', // Default Language for API. Note : Changing the language here will not change the default/login language for Portal user.
		'layout' => 'default',
	);
