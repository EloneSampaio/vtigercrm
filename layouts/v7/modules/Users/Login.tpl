	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/vtiger.jpg">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #15c;">recuperar senha?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							...
							<span>Por favor entre com as informações e envie<a class="forgotPasswordLink pull-right" style="color: #15c;">Voltar</a></span>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="marketingDiv widgetHeight">
				...
				{else}
					<div class="inActiveImgDiv">
						<div>
							<h4>Veja outros serviços da luaitech no nosso Website</h4> <a href="https://luaitech.com">Luaitech.com </a>
						</div>
						<a href="https://luaitech.com" target="_blank" style="margin-right: 25px;"><img src="layouts/v7/resources/Images/mk1.jpeg" style="width: 85%; height: 80%; margin-top: 15px;"/></a>
					</div>
				{/if}
				</div>
			</div>
